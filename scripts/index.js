...
const popupButtonOpenProfileEdit = document.querySelector(
...
const popupButtonCloseAddImage = popupAddImage.querySelector(
  "#popup__button-close"
);
const popupShowImage = document.querySelector(".popup_show-image");
const popupButtonCloseImage = document.querySelector(
...
function handleSubmitAddFormImage(e) {
  e.preventDefault();
  const cardData = createNewCard(
    { name: inputAddImageName.value, link: inputAddLink.value },
    ".element-template"
  );
